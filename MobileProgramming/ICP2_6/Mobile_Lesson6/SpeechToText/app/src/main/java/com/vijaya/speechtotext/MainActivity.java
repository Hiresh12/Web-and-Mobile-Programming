...
public String textInDisplay="Hello, How Can I Help You!";
    @Override
    ...
    private void startVoiceInput() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, textInDisplay);
        try {
                ...
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if(result != null && result.size() > 0) {
                        ...
                        if(result.get(0).equalsIgnoreCase("hello")) {
                            ...
                            mVoiceInputTv.setText(Html.fromHtml("<p style=\"color:red;\">Speaker : What is your name ?</p>"));
                            textInDisplay="Please tell your name";
                            startVoiceInput();
                        }else if(result.get(0).contains("name") || textInDisplay=="Please tell your name"){
                            // Set the Greeting by indexing
                            Log.d("text",textInDisplay);
                            textInDisplay="Hello, How Can I Help You!";
